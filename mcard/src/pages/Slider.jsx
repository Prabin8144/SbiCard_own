    ...
    <>
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        ...
        <SwiperSlide>
            <div className={styles.swipe}>
                <div>
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAUApi9ViQ2blLoNtm1Ne54JqRJB4mOrVN5A&usqp=CAU" alt="" />
                </div>
                <div>
                    <ol>Pay
                        <li>Pay Online</li>
        ...
        <SwiperSlide>
            <div className={styles.swipe}>
                <div>
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYPGEj_iOr47qlzRtmgfuI51kOrtwHgcPVNQ&usqp=CAU" alt="" />
                </div>
                <div>
                    <ol>Offers
                        <li>All Offers</li>
        ...
        <SwiperSlide>
            <div className={styles.swipe}>
                <div>
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrhroaDmyCTvXesxSsxmEwe153jnc0Ckj87A&usqp=CAU" alt="" />
                </div>
                <div>
                    <ol>Rewards
